...
Sega System 1/2, Neogeo MVS, toaplan, Nichibutsu, Final Fight AE CPS2, Prehistoric Isle in 1930, etc...
...
3. if you don't want additionnal Console cores, just remove update_console.sh in same directory as install_coinop.sh
...
just remove it if you don't want main mister to be changed
